...
export const SignInHandler = () => {
    ...
    return user ? (
        ...
        <>
            {/* <GoogleSignIn /> */}
            <div  className="z-[99] flex justify-center gap-1 items-center p-3  bg-inherit rounded-xl text-white max-md:p-2 border-[1px] border-solid border-white text-sm sm:text-lg hover:!bg-white hover:text-black cursor-pointer duration-200 transition-all !py-0 !gap-y-0 margin-0 h-[37px] sm:h-full">
                Beta access
                <FaArrowRight />
            </div>
