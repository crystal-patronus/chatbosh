        ...
        <section className="w-full flex flex-col xl:flex-row items-center gap-6">
            ...
            <Fade triggerOnce>
                <div className="xl:flex-shrink-0 w-full">
                    <video autoPlay muted className="w-full h-[250px] xs:h-[350px] md:h-[500px] xl:w-[600px] large-desktop:w-[700px] xl:h-[500px] border border-solid border-neutral-50 mx-auto lg:mx-0 rounded-xl object-fill">
